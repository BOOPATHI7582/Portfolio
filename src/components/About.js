        ...
        <div className="mx-auto flex lg:flex-row flex-col items-center justify-center">
          ...
          <div className="lg:w-1/2 justify-center lg:p-5 xl:p-7 md:p-5 flex flex-col items-center text-justify">
            ...
            >
              ...
              1 years of experience in the field. <br />
              ...
              Express Js ,Tailwind allowing me to build robust and responsive
            ...
            >
              ...
              <a
                href="https://drive.google.com/drive/folders/1-3uLUdb29j9rYPzgiq5qsQ8ZDDZoJ_3q"
                target="_blank"
                rel="noreferrer"
              >
